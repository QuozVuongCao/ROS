...
rospy.init_node("dwm1001_display")
...
class DisplayInRviz:
    ...
    def start(self):
        rospy.Subscriber("/dwm1001/anchor48", Anchor, self.Anchor0callback)
        rospy.Subscriber("/dwm1001/anchor49", Anchor, self.Anchor1callback)
        rospy.Subscriber("/dwm1001/anchor50", Anchor, self.Anchor2callback)
        rospy.Subscriber("/dwm1001/anchor51", Anchor, self.Anchor3callback)
